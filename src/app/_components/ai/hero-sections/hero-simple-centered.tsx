            ...
            <div className="px-6 pb-24 pt-10 sm:pb-32 lg:col-span-7 lg:px-0 lg:pb-56 lg:pt-48 xl:col-span-6">
              <div className="mx-auto max-w-2xl lg:mx-0">
                ...
                <h1 className="mt-24 text-4xl font-bold tracking-tight text-gray-900 sm:mt-10 sm:text-6xl">
                  Optimize Your Work-Life Balance with Worklife
                </h1>
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  Discover how Worklife helps you solve the pain points of managing work and personal life effectively, boosting productivity and enhancing life quality. Our unique approach brings you closer to achieving financial success and a balanced life.
                </p>
